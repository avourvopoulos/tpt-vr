...
public sealed class InteractiveConsole : MonoBehaviour
{
	...
	public Texture2D InviteFriends;
...
//        status = "Friend Selector called";
	...
	void Update()
	{
		...
		#if UNITY_WEBPLAYER
		if(Application.loadedLevel == 2 && !gameover)
		{
			CallAppRequestAsFriendSelector();
			gameover = true;
		}
		
		if(FB.IsLoggedIn && !getpic)
		{
			getPic();
		}
		#endif
...
//		if(getpic)
		...
		GUI.Label (new Rect (Screen.width-(60), 10, 60, 60), profilePic);
//		if(FB.IsLoggedIn)
//		GUI.Label (new Rect (20, 120, 100, 100), FB.UserId);
//		
...
//
		...
		if(Init.mainscreen)
		{
//			if (GUI.Button(new Rect((Screen.width/2)-100 , 50, 160, 30), FBlogin))	
//	        {
//	            CallFBLogin();
//	            status = "Login called";	
//	        }
			if(FB.IsLoggedIn)
			{
				...
				GUI.Label (new Rect ((Screen.width/2)-50 , 50, 160, 60), "Logged in...");
				GUI.color = Color.white;
			}
			else
			{
				GUI.Label (new Rect ((Screen.width/2)-50 , 50, 160, 60), "Logging...");
			}
		...
		{
			if (GUI.Button(new Rect((Screen.width/2)-70 , Screen.height-35, 150, 30), InviteFriends))	
        	{
				CallAppRequestAsFriendSelector();
			}
		}
...
//		{
//			
//			if (GUI.Button(new Rect((Screen.width/2)-70 , Screen.height-50, 150, 30), InviteFriends))	
//        	{
//				CallAppRequestAsFriendSelector();
//			}			
//		}
...
//		if(FB.IsLoggedIn)
//		{
//			if (GUI.Button(new Rect((Screen.width/2)-60 , 50, 60, 30), "Pic"))	
//       		{
//				getPic();
//			}
//		}
